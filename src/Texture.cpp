...
std::pair<int, int> getOpenGLTextureFormats(TextureFormat textureFormat) {
    ...
    switch(textureFormat) {
        ...
        case TextureFormat::R8I: internalFormat = GL_R8I; format = GL_RED; break;
        case TextureFormat::R8UI: internalFormat = GL_R8UI; format = GL_RED; break;
        case TextureFormat::R16I: internalFormat = GL_R16I; format = GL_RED; break;
        case TextureFormat::R16UI: internalFormat = GL_R16UI; format = GL_RED; break;
        case TextureFormat::R32I: internalFormat = GL_R32I; format = GL_RED; break;
        case TextureFormat::R32UI: internalFormat = GL_R32UI; format = GL_RED; break;
        case TextureFormat::RG8I: internalFormat = GL_RG8I; format = GL_RG; break;
        case TextureFormat::RG8UI: internalFormat = GL_RG8UI; format = GL_RG; break;
        case TextureFormat::RG16I: internalFormat = GL_RG16I; format = GL_RG; break;
        case TextureFormat::RG16UI: internalFormat = GL_RG16UI; format = GL_RG; break;
        case TextureFormat::RG32I: internalFormat = GL_RG32I; format = GL_RG; break;
        case TextureFormat::RG32UI: internalFormat = GL_RG32UI; format = GL_RG; break;
        case TextureFormat::RGB8I: internalFormat = GL_RGB8I; format = GL_RGB; break;
        case TextureFormat::RGB8UI: internalFormat = GL_RGB8UI; format = GL_RGB; break;
        case TextureFormat::RGB16I: internalFormat = GL_RGB16I; format = GL_RGB; break;
        case TextureFormat::RGB16UI: internalFormat = GL_RGB16UI; format = GL_RGB; break;
        case TextureFormat::RGB32I: internalFormat = GL_RGB32I; format = GL_RGB; break;
        case TextureFormat::RGB32UI: internalFormat = GL_RGB32UI; format = GL_RGB; break;
        case TextureFormat::RGBA8I: internalFormat = GL_RGBA8I; format = GL_RGBA; break;
        case TextureFormat::RGBA8UI: internalFormat = GL_RGBA8UI; format = GL_RGBA; break;
        case TextureFormat::RGBA16I: internalFormat = GL_RGBA16I; format = GL_RGBA; break;
        case TextureFormat::RGBA16UI: internalFormat = GL_RGBA16UI; format = GL_RGBA; break;
        case TextureFormat::RGBA32I: internalFormat = GL_RGBA32I; format = GL_RGBA; break;
        case TextureFormat::RGBA32UI: internalFormat = GL_RGBA32UI; format = GL_RGBA; break;
